...
export class Backend implements backendInterface {
    ...
    async createScorecard(arg0: Scorecard): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createScorecard(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async deleteScorecard(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteScorecard(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllScorecards(): Promise<Array<Scorecard>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllScorecards();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getScorecard(arg0: bigint): Promise<Scorecard> {
        if (this.processError) {
            try {
    ...
    async updateScorecard(arg0: bigint, arg1: Scorecard): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateScorecard(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
